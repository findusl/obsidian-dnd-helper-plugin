...
external interface EventListenerInfo {
    var selector: String
    var listener: Function<*>
    var options: dynamic /* Boolean? | AddEventListenerOptions? */
        get() = definedExternally
        set(value) = definedExternally
    var callback: Function<*>
}

external interface AjaxOptions {
    ...
    var error: ((error: Any, req: XMLHttpRequest) -> Any)?
        get() = definedExternally
        set(value) = definedExternally
    var data: dynamic /* Any? | String? | ArrayBuffer? */
        get() = definedExternally
        set(value) = definedExternally
...
external open class AbstractTextComponent<T>(inputEl: T) : ValueComponent<String> {
    open var inputEl: T
    open fun setDisabled(disabled: Boolean): AbstractTextComponent<T> /* this */
...
external fun addIcon(iconId: String, svgContent: String)
...
external open class ButtonComponent(containerEl: HTMLElement) : BaseComponent {
...
external open class Component {
    ...
    open fun <K : String> registerDomEvent(el: Window, type: K, callback: (self: HTMLElement, ev: Any) -> Any)
    open fun <K : String> registerDomEvent(el: Document, type: K, callback: (self: HTMLElement, ev: Any) -> Any)
...
external fun <T : Array<Any>> debounce(cb: (args: Any /* JsTuple<Any> */) -> Any, timeout: Number = definedExternally, resetTimer: Boolean = definedExternally): Debouncer<T>

external interface Debouncer<T : Array<Any>> {
    @nativeInvoke
    operator fun invoke(vararg args: Any /* JsTuple<Any> */)
    fun cancel(): Debouncer<T> /* this */
}

external open class DropdownComponent(containerEl: HTMLElement) : ValueComponent<String> {
    ...
    override fun getValue(): String
    open fun setValue(value: String): DropdownComponent /* this */
    open fun onChange(callback: (value: String) -> Any): DropdownComponent /* this */
}

external open class EditableFileView(leaf: WorkspaceLeaf) : FileView
...
external open class Editor {
    ...
    open fun replaceSelection(replacement: String)
...
external open class ExtraButtonComponent(containerEl: HTMLElement) : BaseComponent {
...
external open class FileManager {
...
external open class FileSystemAdapter : DataAdapter {
    override fun getName(): String
    open fun getBasePath(): String
    override fun mkdir(normalizedPath: String): Promise<Unit>
    override fun trashSystem(normalizedPath: String): Promise<Boolean>
    override fun trashLocal(normalizedPath: String): Promise<Unit>
    override fun rmdir(normalizedPath: String, recursive: Boolean): Promise<Unit>
    override fun read(normalizedPath: String): Promise<String>
    override fun readBinary(normalizedPath: String): Promise<ArrayBuffer>
    override fun write(normalizedPath: String, data: String, options: DataWriteOptions): Promise<Unit>
    override fun writeBinary(normalizedPath: String, data: ArrayBuffer, options: DataWriteOptions): Promise<Unit>
    override fun getResourcePath(normalizedPath: String): String
    override fun remove(normalizedPath: String): Promise<Unit>
    override fun rename(normalizedPath: String, normalizedNewPath: String): Promise<Unit>
    override fun copy(normalizedPath: String, normalizedNewPath: String): Promise<Unit>
    override fun exists(normalizedPath: String, sensitive: Boolean): Promise<Boolean>
    override fun stat(normalizedPath: String): Promise<Stat?>
    override fun list(normalizedPath: String): Promise<ListedFiles>
    open fun getFullPath(normalizedPath: String): String

    companion object {
        fun readLocalFile(path: String): Promise<ArrayBuffer>
        fun mkdir(path: String): Promise<Unit>
    }
}

external open class FileView(leaf: WorkspaceLeaf) : ItemView {
...
external fun fuzzySearch(q: PreparedQuery, text: String): SearchResult?

external open class FuzzySuggestModal<T>(app: App) : SuggestModal<FuzzyMatch<T>> {
    override fun getSuggestions(query: String): Array<FuzzyMatch<T>>
    override fun renderSuggestion(item: FuzzyMatch<T>, el: HTMLElement)
    override fun onChooseSuggestion(item: FuzzyMatch<T>, evt: MouseEvent)
    override fun onChooseSuggestion(item: FuzzyMatch<T>, evt: KeyboardEvent)
    open fun getItems(): Array<T>
    open fun getItemText(item: T): String
    open fun onChooseItem(item: T, evt: MouseEvent)
    open fun onChooseItem(item: T, evt: KeyboardEvent)
}

external fun getAllTags(cache: CachedMetadata): Array<String>?
...
external open class HoverPopover(parent: HoverParent, targetEl: HTMLElement?, waitTime: Number = definedExternally) : Component {
...
external open class ItemView(leaf: WorkspaceLeaf) : View {
...
external fun iterateCacheRefs(cache: CachedMetadata, cb: (ref: ReferenceCache) -> Any): Boolean

external fun iterateRefs(refs: Array<ReferenceCache>, cb: (ref: ReferenceCache) -> Any): Boolean
...
external open class MarkdownEditView(view: MarkdownView) : MarkdownSubView, HoverParent {
    open fun clear()
...
external open class MarkdownPreviewRenderer {
    companion object {
        fun registerPostProcessor(postProcessor: MarkdownPostProcessor, sortOrder: Number = definedExternally)
        fun unregisterPostProcessor(postProcessor: MarkdownPostProcessor)
    }
}

external open class MarkdownPreviewView(containerEl: HTMLElement) : MarkdownRenderer, MarkdownSubView, MarkdownPreviewEvents {
...
external open class MarkdownRenderChild(containerEl: HTMLElement) : Component {
    open var containerEl: HTMLElement
}

external open class MarkdownRenderer(containerEl: HTMLElement) : MarkdownRenderChild, MarkdownPreviewEvents, HoverParent {
    companion object {
...
external open class MarkdownSourceView(view: MarkdownView) : MarkdownSubView, HoverParent {
    open var cmEditor: CodeMirror.Editor
    open fun clear()
    override fun get(): String
    override fun set(data: String, clear: Boolean)
    open fun getSelection(): String
...
external open class MarkdownView(leaf: WorkspaceLeaf) : TextFileView {
    open var editor: Editor
    open var sourceMode: MarkdownSourceView
...
external open class Menu(app: App) : Component {
...
external open class MenuItem(menu: Menu) {
    ...
    open fun onClick(callback: (evt: MouseEvent) -> Any): MenuItem /* this */
}

external open class MetadataCache : Events {
...
external open class Modal(app: App) : CloseableComponent {
    open var app: App
...
external var moment_2: Any

external open class MomentFormatComponent(containerEl: HTMLElement) : TextComponent {
    ...
    open fun setValue(value: String): MomentFormatComponent /* this */
...
external fun parseFrontMatterAliases(frontmatter: Any?): Array<String>?
...
external fun parseFrontMatterStringArray(frontmatter: Any?, key: String, nospaces: Boolean = definedExternally): Array<String>?

external fun parseFrontMatterStringArray(frontmatter: Any?, key: String): Array<String>?

external fun parseFrontMatterStringArray(frontmatter: Any?, key: RegExp, nospaces: Boolean = definedExternally): Array<String>?

external fun parseFrontMatterStringArray(frontmatter: Any?, key: RegExp): Array<String>?

external fun parseFrontMatterTags(frontmatter: Any?): Array<String>?
...
external fun parseLinktext(linktext: String): `T$2`
...
external open class Plugin_2(app: App, manifest: PluginManifest) : Component {
    open var app: App
    ...
    open fun registerMarkdownPostProcessor(postProcessor: MarkdownPostProcessor)
    open fun registerMarkdownCodeBlockProcessor(language: String, handler: (source: String, el: HTMLElement, ctx: MarkdownPostProcessorContext) -> Any)
...
external open class PluginSettingTab(app: App, plugin: Plugin_2) : SettingTab
...
external interface PreparedQuery {
    var query: String
    var tokens: Array<String>
    var fuzzy: Array<String>
}

external fun prepareQuery(query: String): PreparedQuery

external interface Rect_2 {
    var x: Number
    var y: Number
    var w: Number
    var h: Number
...
external fun renderMatches(el: HTMLElement, text: String, matches: SearchMatches?, offset: Number = definedExternally)

external fun renderResults(el: HTMLElement, text: String, result: SearchResult, offset: Number = definedExternally)

external fun resolveSubpath(cache: CachedMetadata, subpath: String): dynamic /* HeadingSubpathResult | BlockSubpathResult */

external open class Scope {
...
external open class SearchComponent(containerEl: HTMLElement) : AbstractTextComponent<HTMLInputElement> {
    open var clearButtonEl: HTMLElement
    override fun onChanged()
}

typealias SearchMatches = Array<dynamic /* JsTuple<Number, Number> */>
...
external fun setIcon(parent: HTMLElement, iconId: String, size: Number = definedExternally)

external open class Setting(containerEl: HTMLElement) {
...
external open class SettingTab {
    open var app: App
    open var containerEl: HTMLElement
...
external open class SliderComponent(containerEl: HTMLElement) : ValueComponent<Number> {
    ...
    open fun setValue(value: Number): SliderComponent /* this */
...
external fun sortSearchResults(results: Array<SearchResultContainer>)
...
external open class SuggestModal<T>(app: App) : Modal, ISuggestOwner<T> {
    ...
    open fun setInstructions(instructions: Array<Instruction>)
...
external open class TextAreaComponent(containerEl: HTMLElement) : AbstractTextComponent<HTMLTextAreaElement>

external open class TextComponent(containerEl: HTMLElement) : AbstractTextComponent<HTMLInputElement>

external open class TextFileView(leaf: WorkspaceLeaf) : EditableFileView {
...
external open class View(leaf: WorkspaceLeaf) : Component {
    open var app: App
...
external open class Workspace : Events {
    ...
    open fun on(name: String /* "resize" | "click" | "layout-ready" | "layout-change" | "css-change" */, callback: () -> Any, ctx: Any = definedExternally): EventRef
    open fun on(name: String /* "resize" | "click" | "layout-ready" | "layout-change" | "css-change" */, callback: () -> Any): EventRef
...
external open class WorkspaceItem : Events {
    open fun getRoot(): WorkspaceItem
}

external open class WorkspaceLeaf : WorkspaceItem {
    open var view: View
...
external open class WorkspaceMobileDrawer : WorkspaceParent

external open class WorkspaceParent : WorkspaceItem

external open class WorkspaceRibbon

external open class WorkspaceSidedock : WorkspaceSplit

external open class WorkspaceSplit : WorkspaceParent

external open class WorkspaceTabs : WorkspaceParent